...
function washing_center_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('washing_center_show_site_title',array(
       'default' => true,
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('washing_center_show_site_title',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Site Title','washing-center'),
       'section' => 'title_tagline'
    ));

    $wp_customize->add_setting('washing_center_show_tagline',array(
       'default' => true,
       'sanitize_callback'	=> 'sanitize_text_field'
    ));
    $wp_customize->add_control('washing_center_show_tagline',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Site Tagline','washing-center'),
       'section' => 'title_tagline'
    ));
	...
	$wp_customize->add_control('washing_center_slider_hide_show',array(
	   	...
	   	'description' => __('Image Size ( 1400px x 660px )','washing-center'),
	...
	$wp_customize->add_section('washing_center_arrange_section',array(
		...
		'description'=> __('This section will appear below the slider.','washing-center'),
		'panel' => 'washing_center_panel_id',
	));
		...
		$manager->add_section(
			new Washing_Center_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'  => esc_url( 'https://www.luzuk.com/product/car-wash-wordpress-theme/' ),
				)
			)
		);
	}
